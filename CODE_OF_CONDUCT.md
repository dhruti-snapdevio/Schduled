...
reported via GitHub's private vulnerability reporting channel (Security tab)
until a dedicated contact is published, or by opening an issue tagged for
maintainer attention if the report itself is not sensitive. All complaints
