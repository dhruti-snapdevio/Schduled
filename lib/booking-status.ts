export const STATUS_STYLES: Record<string, { dotClass: string; badge: string; label: string }> = {
  ...
  reschedule_requested: { dotClass: 'bg-amber-500', badge: 'bg-amber-500/10 text-amber-700',  label: 'Reschedule Requested' },
  rescheduled: { dotClass: 'bg-amber-500',       badge: 'bg-amber-500/10 text-amber-700',     label: 'Rescheduled' },
